...
const NotificationsPage = () => {
  ...
  const incomingRequests = Array.isArray(friendRequests?.incomingReqs) ? friendRequests.incomingReqs : [];
  const acceptedRequests = Array.isArray(friendRequests?.acceptedReqs) ? friendRequests.acceptedReqs : [];
